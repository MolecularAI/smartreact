...
CYCLIC_DINUCLEOTIDE = (
    "O=[P@]1(S)OC[C@H]2O[C@@H]3[C@H](F)[C@@H]2O[P@](=O)(S)OC[C@H]2O[C@H]"
    "([C@H](F)[C@@H]2O1)n1cnc2c(ncnc21)NC/C=C/CNc1ncnc2c1ncn23"
)
METHOXY_FLUORO_BENZALDEHYDE_ESTER = "CCOC(=O)c1cc(C=O)c(F)c(OC)c1"
DIETHYL_BENZYLPHOSPHONATE = "CCOP(=O)(OCC)Cc1ccccc1"
BENZALDEHYDE = "O=Cc1ccccc1"
PROPENYLBENZENE = "CC=Cc1ccccc1"
PHENACYL_BROMIDE = "O=C(CBr)c1ccccc1"
BENZAMIDINE = "N=C(N)c1ccccc1"
PHENYL_PHENYLIMIDAZOLE = "c1ccc(-c2nccn2-c2ccccc2)cc1"
ACETAMIDINE = "CC(=N)N"
METHYL_PHENYLIMIDAZOLE = "Cc1nccn1-c1ccccc1"
N_TERT_BUTYL_AMIDINE = "CSc1ccc(C(=N)NC(C)(C)C)cc1"
N_ETHYL_CYCLIC_AMIDINE = "CC/N=C1/SC(CC(=O)Nc2cccc(C(F)(F)F)c2)C(=O)N1CC"
